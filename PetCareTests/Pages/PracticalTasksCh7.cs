...
namespace PetCareTests.Pages
{
    ...
    class Caller
    {
        static void Main()
        {
            Console.WriteLine($"The total price of your two numbers is {PracticalTasksCh7.TotalPrice("$35.80", "$67.87")}");
            Console.ReadKey();
            Console.Clear();
            Console.WriteLine($"The restangle Area is {PracticalTasksCh7.RectangArea(23, 12)}");
            Console.ReadKey();
            Console.Clear();
            Console.WriteLine($" {PracticalTasksCh7.LoginMatches("Iryna", "Chicago1")}");
            Console.ReadKey();
            Console.Clear();
            Console.WriteLine($"The smallest number is { PracticalTasksCh7.SmallOfThree(23, 12, 34)}");
            Console.ReadKey();
            Console.Clear();
